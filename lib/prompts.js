...
**DESCRIPTION REFINEMENT REQUIREMENTS**:
- The provided incident description is rough and may contain inaccuracies, unclear language, or incomplete information
- You MUST refine, clarify, and improve the description to make it professional, accurate, and comprehensive
- Correct any factual errors, grammatical issues, or unclear statements
- Add missing details that would be relevant for a proper incident investigation
- Use professional safety terminology and clear, concise language
- Ensure the description provides a complete picture of what happened, when, where, and to whom
- Make the description suitable for official incident investigation documentation

Guidelines:
1. "description": MUST refine and improve the provided incident description by:
   - Correcting any inaccuracies or unclear statements
   - Adding missing relevant details (time, location, personnel involved, equipment used)
   - Using professional safety terminology and clear language
   - Ensuring chronological accuracy and logical flow
   - Making it comprehensive enough for proper incident analysis
   - Converting rough, informal language into professional documentation language
2. "fiveWhys": Should follow the 5-Why analysis methodology with logical progression based on the refined incident details
...
- Research and use actual industry-specific terminology, equipment, procedures, and regulations
- **CRITICAL**: The incident description MUST be refined and improved from the rough input provided - correct inaccuracies, add missing details, and make it professional and comprehensive
