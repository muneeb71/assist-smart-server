...
3. "dateConducted": today's date (ISO format).
4. "preparedBy": name and occupation.
5. "reviewedBy": name and occupation.
6. "approvedBy": name and occupation.
7. "responsibleDepartments": array of departments.
8. "hazards": at least 10 unique hazards, each with:
...
9. "atRisk": array, use only these values:
   - "E" = Employees
   - "C" = Contractors
   - "V" = Visitors
   - "P" = Public
...
11. "presentRisk": object with:
    - "severity": integer from 1 to 5
    - "probability": integer from 1 to 5
    - "riskLevel": one of "Low", "Medium", or "High"
12. "furtherControlMeasures": array of new, meaningful controls not listed above.
13. "residualRisk": object with:
...
14. "actionSupervision": array of departments or roles (e.g., "H&S Team", "Site Supervisors").
15. "preparedDate": today's date (ISO format).
16. "reviewDate": today's date (ISO format).
17. "approvedDate": today's date (ISO format).
18. "furtherActions": array of additional actions to be taken.
19. "additionalComments": string for any extra notes.
