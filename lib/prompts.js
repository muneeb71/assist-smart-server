...
{
  "hazard": [
    // At least 10 hazards as strings,
    // Each with brief causes (how it could happen) and effects (potential consequences)
  ],
  "atRisk": [
    // Use these single-letter codes only:
    // E - Employees, C - Contractors, V - Visitors, P - Public, A - All
    // Include the relevant categories for this activity
  ],
  "existingControlMeasures": [
    // Rewrite and enhance the given control measures professionally
  ],
  "presentRisk": {
    "severity": 1-5,
    "probability": 1-5,
  ...
  "furtherControlMeasures": [
    // New control measures NOT already listed in existingControlMeasures
    // Focused on minimizing remaining risks
  ],
  "residualRisk": {
    // Must be lower than presentRisk
    "severity": 1-5,
    "probability": 1-5,
    "riskLevel": "Low" | "Medium" | "High"
  },
  "actionSupervision": [
    // Supervisory roles responsible for implementing controls
    // E.g., "H&S Team", "Site Supervisors", "Facilities Management"
  ]
}
Return only valid JSON. Do not include any explanations, code fences, or formatting.`;
};
