...
- Generate 8-10 additional relevant sections based on the activity type
...
2. "tableOfContents": Should list all generated headings and sub-headings in a logical order with proper hierarchical numbering:
   - Main sections: 1, 2, 3, 4, 5, etc.
   - Subsections: 1.1, 1.2, 1.3, 2.1, 2.2, etc.
...
7. **AUTO-GENERATED SECTIONS**: Generate 8-10 additional relevant sections based on the activity type, including:
...
- **MINIMUM REQUIREMENTS**: Purpose (60-80 words), Scope (60-80 words), Arrangements (maximum 20 words each), Responsibilities (15-25 words per bullet point)
