...
Guidelines:
1. "description": Should rephrase the provided incident description in clearer, more professional language
2. "fiveWhys": Should follow the 5-Why analysis methodology with logical progression based on the incident details
3. "correctiveActionPlan": Should include 3-5 specific, actionable items that address the root causes identified
...
Example output:
{
  "description": "A construction worker sustained minor injuries after falling from a third-floor window cleaning platform due to inadequate fall protection measures and adverse weather conditions.",
  "fiveWhys": [
    {
      "level": 1,
      "question": "Why is it happening?",
  ...
  "correctiveActionPlan": [
    {
      "actionRequired": "Provide and enforce mandatory fall protection equipment for all height-related work",
      "resourcesRequired": "Fall protection harnesses, lanyards, anchor points, and safety training materials",
      "responsibility": "HSE Manager and Site Supervisor",
      "timeframe": "Immediate"
    },
    {
      "actionRequired": "Conduct comprehensive risk assessment for weather-related hazards",
      "resourcesRequired": "Risk assessment templates, weather monitoring equipment, and engineering support",
      "responsibility": "HSE Manager and Engineering Team",
      "timeframe": "Within 7 days"
    },
    {
      "actionRequired": "Implement enhanced safety training program for adverse weather conditions",
      "resourcesRequired": "Training materials, qualified trainers, and training facilities",
      "responsibility": "Training Department and HSE Manager",
      "timeframe": "Within 30 days"
    },
    {
      "actionRequired": "Establish weather monitoring and work suspension protocols",
      "resourcesRequired": "Weather monitoring system, communication protocols, and decision-making framework",
      "responsibility": "Site Manager and HSE Manager",
...
export const getEmergencyFireDrillPrompt = (inputs) => {
  const {
    ...
    // Section 1 - Simulated or Actual Activities
    activity1_immediateDangerEvacuated,
    activity2_zoneOfOriginEvacuated,
    activity3_doorsClosedLatched,
    activity4_alarmManuallyActivated,
    activity5_fireDeptNotified,
    activity6_attemptMadeToExtinguish,
    activity7_attemptProper,
    activity8_sufficientStaffResponded,
    activity9_sceneSupervisionAppropriate,
    activity10_wereInstructionsClear,
    activity11_horizontalEvacuation,
    section1Comments = "",

    // Section 2 - System Features
    featureA_fireAlarmDevices,
    featureB_voiceCommAudible,
    featureC_selfClosingDoors,
    featureD_electromagneticLocksReleased,
    featureE_fireHoseExtinguishersSprinklers,

    // Section 3 - Employee Response
    employeesA_checkedRoomsAndClosedDoors,
    employeesB_designatedStaffAssist,
    employeesC_hazardousEquipShutdown,
    employeesD_corridorsClear,
    section3NoComments = "",
  ...
  return `You are an AI assistant that generates structured JSON for an Emergency Fire Drill report.

Use the following provided form inputs (some may be empty):
- Date: ${date}
- Time: ${time}
- Comprehensive Drill: ${comprehensiveDrill}
- Silent Drill: ${silentDrill}
- Table Talk: ${tableTalk}
- Other Drill: ${otherDrill}
- Scenario Description: ${normalize(scenarioDescription)}

- activity1_immediateDangerEvacuated: ${normalize(activity1_immediateDangerEvacuated)}
- activity2_zoneOfOriginEvacuated: ${normalize(activity2_zoneOfOriginEvacuated)}
- activity3_doorsClosedLatched: ${normalize(activity3_doorsClosedLatched)}
- activity4_alarmManuallyActivated: ${normalize(activity4_alarmManuallyActivated)}
- activity5_fireDeptNotified: ${normalize(activity5_fireDeptNotified)}
- activity6_attemptMadeToExtinguish: ${normalize(activity6_attemptMadeToExtinguish)}
- activity7_attemptProper: ${normalize(activity7_attemptProper)}
- activity8_sufficientStaffResponded: ${normalize(activity8_sufficientStaffResponded)}
- activity9_sceneSupervisionAppropriate: ${normalize(activity9_sceneSupervisionAppropriate)}
- activity10_wereInstructionsClear: ${normalize(activity10_wereInstructionsClear)}
- activity11_horizontalEvacuation: ${normalize(activity11_horizontalEvacuation)}
- section1Comments: ${normalize(section1Comments)}

- featureA_fireAlarmDevices: ${normalize(featureA_fireAlarmDevices)}
- featureB_voiceCommAudible: ${normalize(featureB_voiceCommAudible)}
- featureC_selfClosingDoors: ${normalize(featureC_selfClosingDoors)}
- featureD_electromagneticLocksReleased: ${normalize(featureD_electromagneticLocksReleased)}
- featureE_fireHoseExtinguishersSprinklers: ${normalize(featureE_fireHoseExtinguishersSprinklers)}

- employeesA_checkedRoomsAndClosedDoors: ${normalize(employeesA_checkedRoomsAndClosedDoors)}
- employeesB_designatedStaffAssist: ${normalize(employeesB_designatedStaffAssist)}
- employeesC_hazardousEquipShutdown: ${normalize(employeesC_hazardousEquipShutdown)}
- employeesD_corridorsClear: ${normalize(employeesD_corridorsClear)}
- section3NoComments: ${normalize(section3NoComments)}

- printName: ${normalize(printName)}
- signDate: ${normalize(signDate)}
- evidencePhoto1: ${normalize(evidencePhoto1)}
- evidencePhoto2: ${normalize(evidencePhoto2)}
- evidencePhoto3: ${normalize(evidencePhoto3)}

Instructions:
1. Preserve any provided values exactly for the corresponding fields in the output. Do not modify user-provided values.
2. All checkbox fields must be arrays containing exactly one of ["Yes"] or ["No"]. If user provided a string ("Yes"/"No") or array, normalize to array form reflecting the same answer.
3. "scenarioDescription" should rephrase the provided description professionally; if empty, generate a realistic drill scenario based on typical fire drill contexts.
4. Dates must be ISO format (YYYY-MM-DD). Time must be 24-hour format (HH:MM). If user provided values, keep them as-is; otherwise infer realistic values.
5. If a field is missing or empty, infer realistic, professional values. Comments fields may be empty if nothing is provided.

Output JSON must follow this structure exactly (field names and types are fixed, and no extra fields):
{
  "date": "string - YYYY-MM-DD",
  "time": "string - HH:MM",
  "comprehensiveDrill": "string",
  "silentDrill": "string",
  "tableTalk": "string",
  "otherDrill": "string",
  ...
  "activity1_immediateDangerEvacuated": ["Yes"],
  "activity2_zoneOfOriginEvacuated": ["Yes"],
  "activity3_doorsClosedLatched": ["Yes"],
  "activity4_alarmManuallyActivated": ["Yes"],
  "activity5_fireDeptNotified": ["Yes"],
  "activity6_attemptMadeToExtinguish": ["Yes"],
  "activity7_attemptProper": ["Yes"],
  "activity8_sufficientStaffResponded": ["Yes"],
  "activity9_sceneSupervisionAppropriate": ["Yes"],
  "activity10_wereInstructionsClear": ["Yes"],
  "activity11_horizontalEvacuation": ["Yes"],
  "section1Comments": "string",

  "featureA_fireAlarmDevices": ["Yes"],
  "featureB_voiceCommAudible": ["Yes"],
  "featureC_selfClosingDoors": ["Yes"],
  "featureD_electromagneticLocksReleased": ["Yes"],
  "featureE_fireHoseExtinguishersSprinklers": ["Yes"],

  "employeesA_checkedRoomsAndClosedDoors": ["Yes"],
  "employeesB_designatedStaffAssist": ["Yes"],
  "employeesC_hazardousEquipShutdown": ["Yes"],
  "employeesD_corridorsClear": ["Yes"],
  "section3NoComments": "string",

  "printName": "string",
  "signDate": "string - YYYY-MM-DD",
  "evidencePhoto1": "string",
  "evidencePhoto2": "string",
  "evidencePhoto3": "string"
}

Required fields that must be present with valid values:
[
  "date",
  "time",
  "scenarioDescription",
...
Example output:
{
  "date": "2025-07-22",
  "time": "10:30",
  "comprehensiveDrill": "Full evacuation across all departments",
  "silentDrill": "",
  "tableTalk": "Pre-drill briefing with wardens",
  "otherDrill": "",
  "scenarioDescription": "Smoke detected in the ground-floor electrical room; alarm activated; staff initiated evacuation per procedures.",
  "activity1_immediateDangerEvacuated": ["Yes"],
  "activity2_zoneOfOriginEvacuated": ["Yes"],
  "activity3_doorsClosedLatched": ["Yes"],
  "activity4_alarmManuallyActivated": ["No"],
  "activity5_fireDeptNotified": ["Yes"],
  "activity6_attemptMadeToExtinguish": ["Yes"],
  "activity7_attemptProper": ["Yes"],
  "activity8_sufficientStaffResponded": ["Yes"],
  "activity9_sceneSupervisionAppropriate": ["Yes"],
  "activity10_wereInstructionsClear": ["Yes"],
  "activity11_horizontalEvacuation": ["No"],
  "section1Comments": "Manual activation was not required as the system auto-activated; overall response was timely.",
  "featureA_fireAlarmDevices": ["Yes"],
  "featureB_voiceCommAudible": ["Yes"],
  "featureC_selfClosingDoors": ["Yes"],
  "featureD_electromagneticLocksReleased": ["Yes"],
  ...
  "printName": "Jane Doe",
  "signDate": "2025-07-22",
  "evidencePhoto1": "https://example.com/photos/drill-1.jpg",
  "evidencePhoto2": "",
  "evidencePhoto3": ""
}
