...
5. "introduction": Should provide a detailed explanation of the activity regarding policies and procedures, including background information, context, and importance (minimum 60-80 words)
6. "arrangements": Should include 4-6 key arrangements specific to the activity type, each with:
...
7. "responsibilities": Should include 5-6 departments/roles with detailed responsibilities:
...
8. **AUTO-GENERATED SECTIONS**: Generate 7-9 additional relevant sections based on the activity type, including:
...
9. **CONTENT REQUIREMENTS**: Every section MUST contain substantial, detailed content:
