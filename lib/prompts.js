...
3. "activity": Primary Activity Type (${primaryActivity}).
...
9. "hazards": at least 15 unique hazards, each with:
   - "name": specific hazard name relevant to the industry and ALL activities (${activityTypesText})
...
13. "furtherControlMeasures": array of general additional controls and improvements for the overall activity - must include at least 6-8 comprehensive control measures that are different from individual hazard controls.
...
19. "furtherActions": string for additional actions to be taken (not an array).
...
Schema example:
{
  ...
  "hazards": [
    ...
    },
    {
      ...
      "riskLevel": "Medium",
      "controlMeasures": "Chemical-resistant PPE including nitrile gloves and aprons, local exhaust ventilation systems with HEPA filters, safe handling procedures with proper dilution ratios, chemical storage protocols in designated areas, Safety Data Sheet (SDS) training for all workers, spill response kits with neutralizers",
      "furtherControlMeasures": "Chemical substitution programs using less hazardous alternatives, automated dispensing systems with precise measurements, continuous air monitoring with real-time exposure tracking, emergency showers and eye wash stations within 10 seconds, chemical compatibility charts and segregation protocols, regular medical surveillance for exposed workers"
    }
  ],
  "atRisk": ["E", "C"],
  "existingControlMeasures": [
  ...
  "furtherControlMeasures": [
    "Implement comprehensive safety management system with documented procedures and regular reviews",
    "Establish regular safety audits and inspections with certified safety professionals and corrective action tracking",
    "Develop emergency response procedures with evacuation plans, communication protocols, and emergency contact lists",
    "Conduct periodic risk assessments with updated hazard identification and control measure evaluation",
    "Install advanced monitoring systems with real-time alerts and automated reporting capabilities",
    "Provide specialized safety training programs with competency assessments and certification requirements",
    "Implement engineering controls including automated safety systems and fail-safe mechanisms",
    "Establish safety committees with regular meetings and incident investigation protocols"
  ],
  "residualRisk": {
    "severity": 2,
    "probability": 2,
...
- **COMPREHENSIVE ACTIVITY COVERAGE**: Ensure the risk assessment covers hazards and control measures for ALL specified activities
- **ACTIVITY-SPECIFIC CONTENT**: Include hazards and control measures specific to each activity type while maintaining industry relevance
- DO NOT use generic template content that could apply to any activity or industry
- Every field must contain information that is directly relevant to the combination of ALL activities and "${industry}"
