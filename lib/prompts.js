...
**DYNAMIC SECTION GENERATION**:
- Generate "tableOfContents", "purpose", and "scope" sections as specified
- Generate 8-12 additional relevant sections based on the activity type
- Create appropriate section titles and content that are relevant to the specific activity type
- Include sections such as introduction, arrangements, risk assessment, emergency planning, training, etc.
- Adapt all content to be relevant to the specific activity type and industry context
- Do NOT use generic or hardcoded activity-specific terms unless they apply to the given activity type
- DO NOT include specific real-world facts, locations, names, or coordinates
- Use generic, industry-appropriate examples and terminology
...
3. "purpose": Should clearly state the purpose and goals of the policies and procedures with specific regulatory compliance requirements and project-specific objectives
4. "scope": Should define the applicability of the policies and procedures to specific activities and project with exact project details, site locations, and specific work activities relevant to the activity type
5. **AUTO-GENERATED SECTIONS**: Generate 8-12 relevant sections based on the activity type, including:
