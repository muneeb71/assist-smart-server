...
9. "hazards": at least 15 unique hazards, each with:
   - "name": specific hazard name relevant to the industry and activity
   ...
   - "controlMeasures": comprehensive control measures for this specific hazard (15-25 words)
   - "furtherControlMeasures": additional specific control measures for this hazard (15-25 words)
...
13. "additionalControlMeasures": array of general additional controls and improvements for the overall activity.
...
21. "glossary": object containing industry-specific terms and definitions:
    - Include at least 20 industry-relevant terms
    - Each term should have a clear, professional definition
    - Focus on safety, technical, and industry-specific terminology
    - Terms should be relevant to the specific industry and activity type
...
Schema example:
{
  ...
  "hazards": [
    {
      ...
      "riskLevel": "Medium",
      "controlMeasures": "Immediate cleanup procedures, warning signs placement, non-slip footwear requirement, regular floor inspections",
      "furtherControlMeasures": "Anti-slip floor coatings, drainage system improvements, designated walkways, emergency response procedures"
    },
    {
      ...
      "riskLevel": "High",
      "controlMeasures": "Machine guards installation, lockout procedures, safety training programs, regular equipment inspections",
      "furtherControlMeasures": "Automated safety systems, emergency stop mechanisms, operator certification requirements, maintenance schedules"
    },
    {
      "name": "Chemical Exposure",
      "cause": "Handling cleaning agents and processing chemicals",
      "effect": "Skin irritation, respiratory issues, chemical burns",
      "riskLevel": "Medium",
      "controlMeasures": "PPE requirements, ventilation systems, safe handling procedures, chemical storage protocols",
      "furtherControlMeasures": "Chemical substitution programs, automated dispensing systems, exposure monitoring, emergency showers"
    }
  ],
  "atRisk": ["E", "C"],
  "existingControlMeasures": [
  ...
  "additionalControlMeasures": [
    ...
    "Establish regular safety audits and inspections",
  ...
  "glossary": {
    "Risk Assessment": "Systematic process of identifying hazards and evaluating associated risks to determine appropriate control measures.",
    "Hazard": "Any source, situation, or act with potential to cause harm in terms of human injury, ill health, or damage to property.",
    "Risk": "Combination of the likelihood of occurrence and severity of harm from exposure to a hazard.",
    "Control Measures": "Actions taken to eliminate or reduce risks to an acceptable level.",
    "PPE": "Personal Protective Equipment designed to protect workers from workplace hazards.",
    "Lockout/Tagout": "Safety procedure ensuring dangerous machines are properly shut off and not started up again before maintenance.",
    "Permit to Work": "Formal written system used to control certain types of work that are potentially hazardous.",
    "Near Miss": "Unplanned event that did not result in injury, illness, or damage but had the potential to do so.",
    "Incident": "Unplanned event that results in injury, illness, or damage to property.",
    "Risk Matrix": "Tool used to assess and prioritize risks based on likelihood and severity.",
    "Hierarchy of Controls": "System of approaches to eliminate or reduce exposure to hazards.",
    "Safe System of Work": "Formal procedure that results from systematic examination of a task to identify hazards.",
    "Competent Person": "Individual with sufficient training, experience, and knowledge to perform specific safety functions.",
    "Emergency Response": "Organized response to an emergency situation to minimize harm and damage.",
    "Safety Culture": "Shared attitudes, values, and practices regarding safety in the workplace.",
    "Risk Register": "Document containing details of identified risks and their assessment.",
    "Safety Audit": "Systematic examination of safety management systems and procedures.",
    "Training Needs Analysis": "Process to identify gaps between current and required knowledge and skills.",
    "Safety Committee": "Group of employees and management representatives who meet regularly to discuss safety issues.",
    "Workplace Inspection": "Regular examination of workplace conditions to identify hazards and ensure compliance."
  }
}
...
export const getMethodStatementPrompt = (activityType, industry) => {
...
export const getResponsePlanPrompt = (emergencyType, projectName, industry) => {
  return `**CRITICAL REQUIREMENT**: All generated content MUST be specifically tailored to the "${emergencyType}" emergency type and "${industry}" industry context. Every detail, procedure, and requirement must reflect industry-specific practices, regulations, and emergency protocols. Do NOT generate generic content - ensure everything is directly relevant to the specified emergency type and industry context.

**STRICT CONTENT REQUIREMENTS**:
- DO NOT use generic template content
- EVERY field must contain specific information related to "${emergencyType}" and "${industry}" industry context
- Research and use actual industry-specific terminology, equipment, procedures, and regulations
- Include specific industry standards, permits, and compliance requirements
- Reference actual equipment, materials, and methodologies used in this industry
- Include industry-specific hazards, risk factors, and emergency protocols
- Use industry-specific training requirements and competency standards
- Include specific regulatory references with exact codes and standards
- Include specific equipment models, specifications, and requirements
- Include exact timeframes, measurements, and procedures
...
You are an AI assistant that generates structured JSON for an Emergency Response Plan (ERP) document.
...
**DYNAMIC SECTION GENERATION**:
- Generate appropriate section titles and content based on the emergency type
- For "emergencyEffects" section: Use appropriate title and content based on emergency type (e.g., "Effects of Fire", "Effects of Chemical Spill", "Effects of Suspension Trauma", etc.)
- For "responseProcedures" section: Include procedures appropriate to the emergency type (e.g., fire fighting procedures, chemical spill response, rescue procedures, etc.)
- Adapt all content to be relevant to the specific emergency type and industry context
- Do NOT use generic or hardcoded emergency-specific terms unless they apply to the given emergency type
- DO NOT include specific real-world facts, locations, names, or coordinates
- Use generic, industry-appropriate examples and terminology
- DO NOT include markdown formatting, bold text (**), asterisks, or special formatting
- DO NOT include parentheses with timeframes or specifications in the content text
...

{
  ...
  "sections": [
    ...
    {
      "id": "emergencyEffects",
      "title": "string - appropriate title based on emergency type",
      "type": "mixed",
      "mixedContent": {
        "text": "string - detailed explanation of emergency effects",
        "subtitle": "string - appropriate subtitle",
        "description": "string - description",
        "items": ["string - effect/symptom 1", "string - effect/symptom 2"]
      }
    },
    {
      "id": "training",
...
**STRICT CONTENT REQUIREMENTS**:
1. "scope": Should define the applicability of the plan to specific activities and project with exact project details, site locations, and specific work activities relevant to the emergency type
2. "objective": Should clearly state the purpose and goals of the response plan with specific regulatory compliance requirements and project-specific objectives
3. "definition": Should provide a detailed explanation of the emergency type and its effects with appropriate terminology and specific industry context
4. "rolesAndResponsibilities": Should include specific responsibilities for each role with exact duties, contact information, and project-specific requirements:
   ...
   - emergencyTeam: Direct emergency response operations with specific equipment and procedures
   - employees: General safety duties and cooperation requirements with specific project protocols
5. "emergencyEffects": Should explain the effects and urgency of response with specific timeframes and relevant details appropriate to the emergency type
...
7. "generalPrecautions": Should include key safety measures and time-critical factors with specific procedures, equipment requirements, and timeframes
8. "responseProcedures": Should include appropriate response methods with specific equipment, procedures, and safety requirements based on the emergency type:
   - Include 4-6 different response procedures appropriate to the emergency type
...
9. "records": Should specify documentation and investigation requirements with specific forms, reporting procedures, and regulatory compliance requirements
...
export function getDocumentPrompt(inputsJson, subcategory) {
  ...
  switch (subcategory) {
    ...
    case "Method Planning":
      return getMethodStatementPrompt(inputs.activityType, inputs.industry);
    case "Ptws":
