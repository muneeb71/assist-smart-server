...
// Dummy prompt for incident investigation
export const getIncidentInvestigationPrompt = (
  ...
  return `This is a dummy prompt for incident investigation. Input fields:
...
- Investigation Details: ${investigationDetails}
- Participants: ${participants}
- Witnesses: ${witnesses}
- Departments: ${departments}
- Immediate Causes (Unsafe Acts): ${immediateCausesUnsafeActs}
- Immediate Causes (Unsafe Conditions): ${immediateCausesUnsafeConditions}
- Root Causes (Personal Factors): ${rootCausesPersonalFactors}
