...
- Research and use actual industry-specific terminology, equipment, procedures, and regulations
- **COUNTRY COMPLIANCE**: Ensure all content complies with "${country}" specific regulations, standards, and requirements
...
export const getMethodStatementPrompt = (activityType, industry, country) => {
...
export const getResponsePlanPrompt = (activityType, projectName, industry, country) => {
...
export const getPoliciesAndProceduresPrompt = (activityType, projectName, industry, country) => {
...
**DYNAMIC SECTION GENERATION**:
- Generate "tableOfContents", "purpose", "scope", "arrangements", and "responsibilities" sections as specified
- Generate 6-10 additional relevant sections based on the activity type
- Create appropriate section titles and content that are relevant to the specific activity type
- Include sections such as introduction, risk assessment, emergency planning, training, etc.
- Adapt all content to be relevant to the specific activity type and industry context
- Do NOT use generic or hardcoded activity-specific terms unless they apply to the given activity type
- DO NOT include specific real-world facts, locations, names, or coordinates
- Use generic, industry-appropriate examples and terminology
  ...
  "sections": [
    {
      ...
      "type": "list",
      "items": ["string - list of all generated headings and sub-headings"]
    },
    {
      "id": "purpose",
      "title": "Purpose",
    ...
    },
    {
      ...
      "subsections": [
        {
          "title": "string - arrangement title (e.g., 'Fire Risk Assessment', 'Emergency Planning', 'Team Member Training', 'Safety Checks')",
    ...
    },
    {
      ...
      "subsections": [
        {
          "title": "string - department name (e.g., 'HSE', 'Management', 'Employees', 'Contractors', 'Supervisors')",
...
2. "tableOfContents": Should list all generated headings and sub-headings in a logical order
3. "purpose": Should clearly state the purpose and goals of the policies and procedures with specific regulatory compliance requirements and project-specific objectives (minimum 60-80 words)
4. "scope": Should define the applicability of the policies and procedures to specific activities and project with exact project details, site locations, and specific work activities relevant to the activity type (minimum 60-80 words)
5. "arrangements": Should include 4-6 key arrangements specific to the activity type, each with:
   - Clear title (e.g., 'Fire Risk Assessment', 'Emergency Planning', 'Team Member Training', 'Safety Checks')
   - Detailed description of the arrangement (minimum 40-60 words per arrangement)
   - Responsibility assignment (e.g., "Responsibility: HSE")
6. "responsibilities": Should include 5-6 departments/roles with detailed responsibilities:
...
7. **AUTO-GENERATED SECTIONS**: Generate 6-10 additional relevant sections based on the activity type, including:
   - Introduction and background information relevant to the activity type
...
8. **CONTENT REQUIREMENTS**: Every section MUST contain substantial, detailed content:
...
- **MINIMUM REQUIREMENTS**: Purpose (60-80 words), Scope (60-80 words), Arrangements (40-60 words each), Responsibilities (15-25 words per bullet point)
...
export function getDocumentPrompt(inputsJson, subcategory) {
  ...
  switch (subcategory) {
    ...
    case "Method Planning":
      return getMethodStatementPrompt(inputs.activityType, inputs.industry, inputs.country);
    case "Ptws":
